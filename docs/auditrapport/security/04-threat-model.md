...
| T05 | Logging | Patientgegevens kunnen in logs terechtkomen. | Information Disclosure, Repudiation | Vertrouwelijkheid, traceerbaarheid | 3 | 4 | 12 | `AttachmentsServiceImpl.java` logt nu minimale technische context voor attachment-fetches. | Gedeeltelijk gemitigeerd; `AttachmentsServiceImplTest` bewijst dat patientnaam, geboortedatum, interne id en identifiers niet in de logtekst staan. |
