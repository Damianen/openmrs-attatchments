...
| A.8.29 Security testing | Belangrijke security-eisen moeten aantoonbaar getest worden. | Security regressies kunnen terugkomen zonder automatische testdekking of zonder pentest-hertestbewijs. | Security regressietests draaien in Maven workflow; JaCoCo artifacts worden opgeslagen; pentestdocument is bijgewerkt met 10 cases; P1-hertestbewijs staat in de bewijsmap. | `10-coverage-quality-gate.md`; `14-pentest-review-punchlist.md`; `docs/auditrapport/08-pentest.pdf`; `bewijs/pentest/README.md`; `bewijs/scanning/maven-tests-coverage-artifacts-success.png`; `bewijs/scanning/jacoco-api-coverage-overview.png`; `bewijs/scanning/jacoco-omod-security-coverage-overview.png`; `.github/workflows/maven-tests.yml` | Aanwezig; owneractie nodig om Maven Tests verplicht te maken voor merge. |
