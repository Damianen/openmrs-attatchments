...
| Security testing | Security-eisen moeten getest en reproduceerbaar zijn. | Maven Tests workflow draait security regressietests en uploadt JaCoCo artifacts; pentestdocument bevat 10 cases. | `.github/workflows/maven-tests.yml`; `10-coverage-quality-gate.md`; `bewijs/scanning/maven-tests-coverage-artifacts-success.png`; `docs/auditrapport/08-pentest.pdf` | Aanwezig; required check vereist owneractie |
...
| Maven Tests required check | Securitytests moeten release/merge aantoonbaar blokkeren bij falen. | Repository-owner moet Maven Tests als required check selecteren. |
