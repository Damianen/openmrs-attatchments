...
**Bewijs & Analyse:**
Er is logging aanwezig om te registreren welke bestanden worden opgevraagd, wat een goede eerste stap is richting compliance, maar de manier waarop dit wordt gedaan levert een datalek van medische persoonsgegevens (PII) in de systeemlogs op.
